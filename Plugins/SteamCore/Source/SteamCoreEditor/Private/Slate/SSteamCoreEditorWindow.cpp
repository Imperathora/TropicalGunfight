...
void SUpdaterCoreWindow::Construct(const FArguments& InArgs)
{
	...
	[
		SNew(SBorder)
		.Padding(0)
		.BorderImage(FSteamCoreEditorStyle::GetBrush("SteamCoreEditor.MainMenuBackground"))
		[
			SNew(SVerticalBox)
			+ SVerticalBox::Slot()
			.AutoHeight()
			[
				...
				[
					SNew(SBorder)
					.BorderImage(FSteamCoreEditorStyle::GetBrush("SteamCoreEditor.TitleBackground"))
					.Padding(8.f)
					[
						SNew(STextBlock)
				...
				[
					...
					[
						SNew(SButton)
						.ButtonStyle(&FSteamCoreEditorStyle::Get().GetWidgetStyle<FButtonStyle>("SteamCoreEditor.UpdaterCoreButton")) 
			...
			[
				SNew(SBorder)
				.BorderImage(FSteamCoreEditorStyle::GetBrush("SteamCoreEditor.ContentBackground"))
				.Padding(0)
				[
			...
			[
				...
				[
					...
					[
						SNew(SButton)
						.ButtonStyle(&FSteamCoreEditorStyle::Get().GetWidgetStyle<FButtonStyle>("SteamCoreEditor.UpdaterCoreButtonRed")) 
						.OnClicked_Lambda([this]
						{
