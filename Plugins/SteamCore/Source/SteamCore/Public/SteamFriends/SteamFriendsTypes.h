...
FORCEINLINE int32 operator*(ESteamFriendFlags flags)
{
	...
	case ESteamFriendFlags::None:
		FlagValue = EFriendFlags::k_EFriendFlagNone;
		break;
	case ESteamFriendFlags::Blocked:
		FlagValue = EFriendFlags::k_EFriendFlagBlocked;
		break;
	case ESteamFriendFlags::FriendshipRequested:
		FlagValue = EFriendFlags::k_EFriendFlagFriendshipRequested;
		break;
	case ESteamFriendFlags::Immediate:
		FlagValue = EFriendFlags::k_EFriendFlagImmediate;
		break;
	case ESteamFriendFlags::ClanMember:
		FlagValue = EFriendFlags::k_EFriendFlagClanMember;
		break;
	case ESteamFriendFlags::OnGameServer:
		FlagValue = EFriendFlags::k_EFriendFlagOnGameServer;
		break;
	case ESteamFriendFlags::RequestingFriendship:
		FlagValue = EFriendFlags::k_EFriendFlagRequestingFriendship;
		break;
	case ESteamFriendFlags::RequestingInfo:
		FlagValue = EFriendFlags::k_EFriendFlagRequestingInfo;
		break;
	case ESteamFriendFlags::Ignored:
		FlagValue = EFriendFlags::k_EFriendFlagIgnored;
		break;
	case ESteamFriendFlags::IgnoredFriend:
		FlagValue = EFriendFlags::k_EFriendFlagIgnoredFriend;
		break;
	case ESteamFriendFlags::ChatMember:
		FlagValue = EFriendFlags::k_EFriendFlagChatMember;
		break;
	case ESteamFriendFlags::All:
		FlagValue = EFriendFlags::k_EFriendFlagAll;
		break;
	}
...
public:
	...
	FSetPersonaNameResponse(const SetPersonaNameResponse_t& data)
		: Result(_SteamResult(data.m_result)), bSuccess(data.m_bSuccess), bLocalSuccess(data.m_bLocalSuccess)
	{}
};
