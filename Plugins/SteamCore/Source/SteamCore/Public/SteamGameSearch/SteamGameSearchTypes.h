...
{
	Invalid = 0,
	FailedToConnect = 1, // failed to connect after confirming
	Abandoned = 2,		// quit game without completing it
	Kicked = 3,			// kicked by other players/moderator/server rules
	Incomplete = 4,		// player stayed to end but game did not conclude successfully ( nofault to player )
	Completed = 5,		// player completed game
};
