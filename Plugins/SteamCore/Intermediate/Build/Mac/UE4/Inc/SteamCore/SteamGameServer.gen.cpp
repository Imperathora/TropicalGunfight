...
// End Cross Module References
	...
	DEFINE_FUNCTION(UGameServer::execGetServerSteamID_PureCompact)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UGameServer::execGetServerSteamID_Pure)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UGameServer::execGetServerPublicIP_PureCompact)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UGameServer::execGetServerPublicIP_Pure)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	void UGameServer::StaticRegisterNativesUGameServer()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "GetServerPublicIP_Pure", &UGameServer::execGetServerPublicIP_Pure },
			{ "GetServerPublicIP_PureCompact", &UGameServer::execGetServerPublicIP_PureCompact },
			{ "GetServerSteamID", &UGameServer::execGetServerSteamID },
			{ "GetServerSteamID_Pure", &UGameServer::execGetServerSteamID_Pure },
			{ "GetServerSteamID_PureCompact", &UGameServer::execGetServerSteamID_PureCompact },
	...
	struct Z_Construct_UFunction_UGameServer_GetServerPublicIP_Pure_Statics
	{
		struct GameServer_eventGetServerPublicIP_Pure_Parms
		{
			FString ReturnValue;
		};
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_ReturnValue;
	...
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UGameServer_GetServerPublicIP_Pure_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(GameServer_eventGetServerPublicIP_Pure_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UGameServer_GetServerPublicIP_Pure_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UGameServer_GetServerPublicIP_Pure_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UGameServer_GetServerPublicIP_Pure_Statics::Function_MetaDataParams[] = {
		{ "Category", "SteamCore|GameServer" },
		{ "Comment", "/**\n\x09* Gets the Steam ID of the game server.\n\x09*/" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameServer_GetServerPublicIP_Pure_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGameServer, nullptr, "GetServerPublicIP_Pure", nullptr, nullptr, sizeof(GameServer_eventGetServerPublicIP_Pure_Parms), Z_Construct_UFunction_UGameServer_GetServerPublicIP_Pure_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameServer_GetServerPublicIP_Pure_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UGameServer_GetServerPublicIP_Pure_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameServer_GetServerPublicIP_Pure_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UGameServer_GetServerPublicIP_Pure()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UGameServer_GetServerPublicIP_Pure_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UGameServer_GetServerPublicIP_PureCompact_Statics
	{
		struct GameServer_eventGetServerPublicIP_PureCompact_Parms
		{
			FString ReturnValue;
		};
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_ReturnValue;
	...
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UGameServer_GetServerPublicIP_PureCompact_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(GameServer_eventGetServerPublicIP_PureCompact_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UGameServer_GetServerPublicIP_PureCompact_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UGameServer_GetServerPublicIP_PureCompact_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UGameServer_GetServerPublicIP_PureCompact_Statics::Function_MetaDataParams[] = {
		{ "Category", "SteamCore|GameServer" },
		{ "Comment", "/**\n\x09* Gets the Steam ID of the game server.\n\x09*/" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameServer_GetServerPublicIP_PureCompact_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGameServer, nullptr, "GetServerPublicIP_PureCompact", nullptr, nullptr, sizeof(GameServer_eventGetServerPublicIP_PureCompact_Parms), Z_Construct_UFunction_UGameServer_GetServerPublicIP_PureCompact_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameServer_GetServerPublicIP_PureCompact_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UGameServer_GetServerPublicIP_PureCompact_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameServer_GetServerPublicIP_PureCompact_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UGameServer_GetServerPublicIP_PureCompact()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UGameServer_GetServerPublicIP_PureCompact_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_UGameServer_GetServerSteamID_Pure_Statics
	{
		struct GameServer_eventGetServerSteamID_Pure_Parms
		{
			FSteamID ReturnValue;
		};
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_ReturnValue;
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UGameServer_GetServerSteamID_Pure_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(GameServer_eventGetServerSteamID_Pure_Parms, ReturnValue), Z_Construct_UScriptStruct_FSteamID, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UGameServer_GetServerSteamID_Pure_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UGameServer_GetServerSteamID_Pure_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UGameServer_GetServerSteamID_Pure_Statics::Function_MetaDataParams[] = {
		{ "Category", "SteamCore|GameServer" },
		{ "Comment", "/**\n\x09* Gets the Steam ID of the game server.\n\x09*/" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameServer_GetServerSteamID_Pure_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGameServer, nullptr, "GetServerSteamID_Pure", nullptr, nullptr, sizeof(GameServer_eventGetServerSteamID_Pure_Parms), Z_Construct_UFunction_UGameServer_GetServerSteamID_Pure_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameServer_GetServerSteamID_Pure_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UGameServer_GetServerSteamID_Pure_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameServer_GetServerSteamID_Pure_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UGameServer_GetServerSteamID_Pure()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UGameServer_GetServerSteamID_Pure_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UGameServer_GetServerSteamID_PureCompact_Statics
	{
		struct GameServer_eventGetServerSteamID_PureCompact_Parms
		{
			FSteamID ReturnValue;
		};
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_ReturnValue;
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UGameServer_GetServerSteamID_PureCompact_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(GameServer_eventGetServerSteamID_PureCompact_Parms, ReturnValue), Z_Construct_UScriptStruct_FSteamID, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UGameServer_GetServerSteamID_PureCompact_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UGameServer_GetServerSteamID_PureCompact_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UGameServer_GetServerSteamID_PureCompact_Statics::Function_MetaDataParams[] = {
		{ "Category", "SteamCore|GameServer" },
		{ "Comment", "/**\n\x09* Gets the Steam ID of the game server.\n\x09*/" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameServer_GetServerSteamID_PureCompact_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGameServer, nullptr, "GetServerSteamID_PureCompact", nullptr, nullptr, sizeof(GameServer_eventGetServerSteamID_PureCompact_Parms), Z_Construct_UFunction_UGameServer_GetServerSteamID_PureCompact_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameServer_GetServerSteamID_PureCompact_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UGameServer_GetServerSteamID_PureCompact_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameServer_GetServerSteamID_PureCompact_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UGameServer_GetServerSteamID_PureCompact()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UGameServer_GetServerSteamID_PureCompact_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UGameServer_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UGameServer_AssociateWithClan, "AssociateWithClan" }, // 2229905541
		{ &Z_Construct_UFunction_UGameServer_BeginAuthSession, "BeginAuthSession" }, // 32934300
		{ &Z_Construct_UFunction_UGameServer_BLoggedOn, "BLoggedOn" }, // 1951931471
		{ &Z_Construct_UFunction_UGameServer_BSecure, "BSecure" }, // 1557596750
		{ &Z_Construct_UFunction_UGameServer_BUpdateUserData, "BUpdateUserData" }, // 1470528829
		{ &Z_Construct_UFunction_UGameServer_CancelAuthTicket, "CancelAuthTicket" }, // 1767464744
		{ &Z_Construct_UFunction_UGameServer_ClearAllKeyValues, "ClearAllKeyValues" }, // 3925771130
		{ &Z_Construct_UFunction_UGameServer_ComputeNewPlayerCompatibility, "ComputeNewPlayerCompatibility" }, // 2107174256
		{ &Z_Construct_UFunction_UGameServer_CreateUnauthenticatedUserConnection, "CreateUnauthenticatedUserConnection" }, // 2134245423
		{ &Z_Construct_UFunction_UGameServer_EnableHeartbeats, "EnableHeartbeats" }, // 2265896826
		{ &Z_Construct_UFunction_UGameServer_EndAuthSession, "EndAuthSession" }, // 3986949024
		{ &Z_Construct_UFunction_UGameServer_ForceHeartbeat, "ForceHeartbeat" }, // 1507730213
		{ &Z_Construct_UFunction_UGameServer_GetAuthSessionTicket, "GetAuthSessionTicket" }, // 1360870523
		{ &Z_Construct_UFunction_UGameServer_GetServerPublicIP, "GetServerPublicIP" }, // 3369522142
		{ &Z_Construct_UFunction_UGameServer_GetServerPublicIP_Pure, "GetServerPublicIP_Pure" }, // 2005698400
		{ &Z_Construct_UFunction_UGameServer_GetServerPublicIP_PureCompact, "GetServerPublicIP_PureCompact" }, // 1208043364
		{ &Z_Construct_UFunction_UGameServer_GetServerSteamID, "GetServerSteamID" }, // 1808059878
		{ &Z_Construct_UFunction_UGameServer_GetServerSteamID_Pure, "GetServerSteamID_Pure" }, // 3181993295
		{ &Z_Construct_UFunction_UGameServer_GetServerSteamID_PureCompact, "GetServerSteamID_PureCompact" }, // 3345823500
		{ &Z_Construct_UFunction_UGameServer_LogOff, "LogOff" }, // 770151082
		{ &Z_Construct_UFunction_UGameServer_LogOn, "LogOn" }, // 2967837259
		{ &Z_Construct_UFunction_UGameServer_LogOnAnonymous, "LogOnAnonymous" }, // 2473855766
		{ &Z_Construct_UFunction_UGameServer_RequestUserGroupStatus, "RequestUserGroupStatus" }, // 645987232
		{ &Z_Construct_UFunction_UGameServer_SetBotPlayerCount, "SetBotPlayerCount" }, // 4208757965
		{ &Z_Construct_UFunction_UGameServer_SetDedicatedServer, "SetDedicatedServer" }, // 3129310000
		{ &Z_Construct_UFunction_UGameServer_SetGameData, "SetGameData" }, // 344948201
		{ &Z_Construct_UFunction_UGameServer_SetGameDescription, "SetGameDescription" }, // 4083784005
		{ &Z_Construct_UFunction_UGameServer_SetGameTags, "SetGameTags" }, // 3871881143
		{ &Z_Construct_UFunction_UGameServer_SetHeartbeatInterval, "SetHeartbeatInterval" }, // 2716178282
		{ &Z_Construct_UFunction_UGameServer_SetKeyValue, "SetKeyValue" }, // 3181167457
		{ &Z_Construct_UFunction_UGameServer_SetMapName, "SetMapName" }, // 1448958247
		{ &Z_Construct_UFunction_UGameServer_SetMaxPlayerCount, "SetMaxPlayerCount" }, // 2439193716
		{ &Z_Construct_UFunction_UGameServer_SetModDir, "SetModDir" }, // 4227040230
		{ &Z_Construct_UFunction_UGameServer_SetPasswordProtected, "SetPasswordProtected" }, // 1069166402
		{ &Z_Construct_UFunction_UGameServer_SetProduct, "SetProduct" }, // 1584236079
		{ &Z_Construct_UFunction_UGameServer_SetRegion, "SetRegion" }, // 715459539
		{ &Z_Construct_UFunction_UGameServer_SetServerName, "SetServerName" }, // 2954158494
		{ &Z_Construct_UFunction_UGameServer_SetSpectatorPort, "SetSpectatorPort" }, // 1196160965
		{ &Z_Construct_UFunction_UGameServer_SetSpectatorServerName, "SetSpectatorServerName" }, // 3928566636
		{ &Z_Construct_UFunction_UGameServer_UserHasLicenseForApp, "UserHasLicenseForApp" }, // 659971272
		{ &Z_Construct_UFunction_UGameServer_WasRestartRequested, "WasRestartRequested" }, // 3309444721
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UGameServer, 3003426402);
